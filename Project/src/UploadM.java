...
public class UploadM implements ActionListener, MouseListener
{
	public JFrame frame;
	JButton button3;
	JButton button4;
	...
	public UploadM (String pk)
	{
		...
		/*********** setting labels ***********/
			JLabel label = new JLabel(new ImageIcon("images/uploadn.png"));
		...
		/***********************************/
			...
			/*********** setting buttons *************/
				...
				button5 = new JButton();
					...
					button5.setFont(new Font("Viking Squad", Font.PLAIN, 18));
