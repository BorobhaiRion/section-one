...
public class Customer extends JFrame
{
	...
	public Customer(String pk)
	{
		...
		bBton = new JButton("BMW", new ImageIcon("images/bmwlogo.jpg"));
		...
		hBton = new JButton("HONDA", new ImageIcon("images/hondalogo.png"));
		...
		tBton = new JButton("TOYOTA", new ImageIcon("images/toyotalogo.png"));
		...
		aBton = new JButton("AUDI", new ImageIcon("images/audilogo.png"));
		...
		nBton = new JButton("TESLA", new ImageIcon("images/teslalogo.png"));
		...
		sBton = new JButton("NISSAN", new ImageIcon("images/nissanlogo.png"));
		...
		sBtn = new JButton("Purchase History");
			...
			public void actionPerformed(ActionEvent e)
			{
				 ...
				 EventQueue.invokeLater(new Runnable()
		        {
			        public void run()
			        {
				     try
					    {
							ImageIcon a = new ImageIcon("images/Untitled-1.png");
		...
		bg = new JLabel((new ImageIcon("images/ff.jpg")));
