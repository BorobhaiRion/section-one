...
public class Sales extends JFrame implements ActionListener {
    ...
    public Sales(String pk) {
        ...
        panel =  new JLabel(new ImageIcon("images/oo.jpg"));
        ...
        c1 = new JButton(new ImageIcon("images/bmwlogo.jpg"));
        c1.setBounds(100, 130, 150, 150);
        panel.add(c1);

        c2 = new JButton(new ImageIcon("images/hondalogo.png"));
        c2.setBounds(300, 130, 150, 150);
        panel.add(c2); 

        c3 = new JButton(new ImageIcon("images/toyotalogo.png"));
        c3.setBounds(500, 130, 150, 150);
        panel.add(c3);

        c4 = new JButton(new ImageIcon("images/audilogo.png"));
        c4.setBounds(100, 330, 150, 150);
        panel.add(c4);

        c5 = new JButton(new ImageIcon("images/teslalogo.png"));
        c5.setBounds(300, 330, 150, 150);
        panel.add(c5);

        c6 = new JButton(new ImageIcon("images/nissanlogo.png"));
