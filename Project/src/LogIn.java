...
public class LogIn extends JFrame implements ActionListener {  
	...
	LogIn() {  
		...
		JLabel l5=new JLabel(new ImageIcon("images/lock.png"));   
		...
		JLabel l4=new JLabel(new ImageIcon("images/user.png"));    
		...
		//Adding logo
		JLabel label1 = new JLabel(new ImageIcon("images/nn.png"));
		...
		JLabel label = new JLabel(new ImageIcon("images/Big.jpg"));
		...
		//change icon
		Image icon = Toolkit.getDefaultToolkit().getImage("images/car.png");
		setIconImage(icon);
