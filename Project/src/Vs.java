...
public class Vs extends JFrame implements ActionListener , MouseListener
{
	...
	{    
		...
		bg = new JLabel((new ImageIcon("images/gg.jpg")));//(new ImageIcon("images/bgs.jpg"));
		...
		{
        try {
                File file = new File("data/SD.txt");
